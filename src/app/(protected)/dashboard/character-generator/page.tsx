...
import CharacterPromptInput from "@/components/module2/CharacterPromptInput";
...
import GeneratedCharacterPreview from "@/components/module2/GeneratedCharacterPreview";
...
export default function CharacterGeneratorPage() {
  ...
  const handleDownload = () => {
    ...
    link.download = `character-${selectedCharacter?.name}-${Date.now()}.png`;
    link.click();
  };
  ...
  return (
    <div className="container mx-auto max-w-7xl space-y-6 p-6">
      <div className="space-y-2">
        <h1 className="text-3xl font-bold">Character Model Generator</h1>
        <p className="text-muted-foreground">
          Upload character models and generate custom scenes with AI
        </p>
      </div>
